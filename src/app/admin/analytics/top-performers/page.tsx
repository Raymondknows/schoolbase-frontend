    ...
    <div className="mx-auto max-w-7xl space-y-6 px-0 py-4 sm:px-8 sm:py-8 lg:px-12">
      ...
      <div className="relative flex items-end justify-between">
        <div>
          ...
          <h1 className="mt-3 text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">Top performers</h1>
          <p className="mt-2 text-sm leading-6 text-muted">Students with the highest scores across assessments.</p>
        </div>
      </div>
      </header>
